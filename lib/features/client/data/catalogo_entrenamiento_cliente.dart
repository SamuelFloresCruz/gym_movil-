  ...
  static const muscles = [
    ...
    TrainingMuscle(
      ...
      parts: [
        TrainingMusclePart(
          name: 'Dorsal ancho',
          exercises: ['Dominadas', 'Jalon al pecho', 'Pullover en polea'],
        ),
        TrainingMusclePart(
          name: 'Trapecio',
          exercises: ['Encogimientos', 'Remo al cuello', 'Farmer walk'],
        ),
        TrainingMusclePart(
          name: 'Romboides',
          exercises: ['Remo sentado', 'Remo con barra', 'Remo unilateral'],
        ),
        TrainingMusclePart(
